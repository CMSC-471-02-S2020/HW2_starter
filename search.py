...
class Problem:
    ...
    def goal_test(self, state):
        ...
        checking against a single self.goal != enough."""
...
class Node:
    ...
    def child_node(self, problem, action):
        ...
        #print(f'next_state is {next_state}') #xxx
...
def breadth_first_graph_search(problem):
    ...
    explored = set()
    while frontier:
        #print(f"frontier:{frontier}, explored:{explored}") #xxx
        node = frontier.popleft()
        explored.add(node.state)
...
def and_or_graph_search(problem):
    ...
    or failure if the former != possible."""
...
def genetic_search(problem, ngen=1000, pmut=0.1, n=20):
    ...
    # NOTE: This != tested and might not work.
